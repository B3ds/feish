 ...
 */
    ...
    public function register() {         
        ...
        if($data){
            ...
            if(isset($data['mci_number']) && $data['mci_number'] != ''){
                $data['user_type'] = 2;
            }else{
                $data['user_type'] = 4;
            }             
            ...
            if ($this->User->save($user)) {
                ...
                $fetch_data = $this->User->find('first', array('fields'=>array('User.id','User.is_verified','User.is_active','User.salutation','User.first_name','User.last_name','User.email','User.created','User.mobile','User.user_type','User.mci_number'),'conditions' => array('User.id' => $registerd_id)));
